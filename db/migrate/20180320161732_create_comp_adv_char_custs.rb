class CreateCompAdvCharCusts < ActiveRecord::Migration[5.0]
## it is ommited since it is just maths calculations that can be done on running time
#  def change
#    create_table :comp_adv_char_custs do |t|
#
#      t.belongs_to :comp_prod, foreign_key: true, null: false
#      t.belongs_to :cust_adv_char, foreign_key: true, null: false
#
...
#      t.timestamps
#    end
#     add_index :comp_adv_char_custs, [:comp_prod_id, :cust_adv_char_id], unique: true
#  end
end
