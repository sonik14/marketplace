class CreateCompProdQWebs < ActiveRecord::Migration[5.0]
  def change
    create_table :comp_prod_q_webs do |t|
      ...
      t.integer :Seq, unsigned: true, null: false #sequence in sorting products on website (1 first product etc)
    ...
    add_index :comp_prod_q_webs, [:comp_q_web_id, :Seq], unique: true, name: 'index_comp_prod_q_webs_on_prod_q_and_web_and_Seq'
  end
end
